...
object BookDetailsTestTags {
    const val BookDetailHeaderTestTag = "BookDetailHeaderTestTag"
    const val TablesTitleTestTag = "TablesTitleTestTag"

    const val BookDetailsDescriptionTestTag = "BookDetailsDescriptionTestTag"
    ...
    const val StageItemTestTagPrefix = "StageItemTestTag_"
}